...
const AddProduct = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    try{
        const { seller_id, name, price, image, quantity, description, category_id } = formData;
        const product = {
            seller_id,
            name,
            price: Number(price),
    ...
    <>
        <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="">
                ...
                Image
                <input name='image' type="text" value={formData.image} onChange={handleFormChange} required/>
            <label htmlFor="">
                Description
                <textarea name='description' type="text" value={formData.description} onChange={handleFormChange} required/>
            </label>
            <select name="category_id" id="" onChange={handleFormChange} value={formData.category_id}>
